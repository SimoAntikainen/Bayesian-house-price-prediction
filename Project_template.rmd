...
ppc_loo_pit_overlay(c(original_target[training_indices]), yrep = replicated_data,
                    lw = lw_lin)
ppc_loo_ribbon(c(original_target[training_indices]), yrep = replicated_data,
               lw = lw_lin, psis_object = psis_lin)
ppc_loo_intervals(c(original_target[training_indices]),
                  yrep = replicated_data, psis_object = psis_lin)
```
